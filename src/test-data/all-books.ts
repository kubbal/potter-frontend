...
export const ALL_BOOKS: Book[] = [{
    ...
    releaseDate: new Date("Jun 26, 1997"),
  ...
  releaseDate: new Date("Jul 2, 1998"),
  ...
  releaseDate: new Date("Jul 8, 1999"),
  ...
  releaseDate: new Date("Jul 8, 2000"),
  ...
  releaseDate: new Date("Jun 21, 2003"),
  ...
  releaseDate: new Date("Jul 16, 2005"),
  ...
  releaseDate: new Date("Jul 21, 2007"),
  ...
  releaseDate: new Date("Jul 30, 2016"),
